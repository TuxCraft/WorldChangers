...
public class WorldChangersCore
{
  ...
  {
    volcanicRock = new BlockVolcanicRock(252).setHardness(1.5F).setResistance(10.0F).setStepSound(new StepSound("stone", 1.0F, 1.0F)).setUnlocalizedName("volcanicRock");

    GameRegistry.registerBlock(volcanicRock);
    LanguageRegistry.addName(volcanicRock, "Volcanic Rock");

    ash = new itemWorldChangers(8000, "ash").setCreativeTab(CreativeTabs.tabMaterials);
