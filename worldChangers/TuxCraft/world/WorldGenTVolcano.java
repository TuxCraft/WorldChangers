...
public class WorldGenTVolcano extends WorldGenerator {
	...
	public boolean generate(World world, Random random, int x, int y, int z) {
		...
		int baseRadius = (random.nextInt(4) + 3) * 5;
		...
		WorldGenUtils.drawCube(x - 2, curY - 5, z - 2, 5, 5, 5, Block.netherBrick.blockID, world);
		WorldGenUtils.drawCube(x - 2, curY - 4, z - 2, 5, 3, 5, Block.fenceIron.blockID, world);
		WorldGenUtils.drawCube(x - 1, curY - 4, z - 1, 3, 4, 3, Block.stoneBrick.blockID, world);
		WorldGenUtils.clearCube(x - 1, curY - 4, z - 1, 3, 3, 3, world);
		world.setBlock(x, curY - 1, z, Block.glowStone.blockID);

		world.setBlock(x, curY - 4, z, Block.chest.blockID);
		TileEntityChest tileentitychest = (TileEntityChest) world.getBlockTileEntity(x, curY - 4, z);
